 ...
 */
public class AssignmentMap5 {
    TreeMap<String,String> M1;

    public AssignmentMap5(){
        M1 = new TreeMap<>();
    }
    ...
    TreeMap<String,String> reverseMap() {
        TreeMap<String,String> reverseMap = new TreeMap<>();
        Set set = M1.entrySet();
        Iterator<Map.Entry> itr = set.iterator();
    ...
    public static void main(String[] args) {
        AssignmentMap5 object = new AssignmentMap5();
        object.saveCountryCapital("India","Delhi");
        TreeMap<String,String> m1 = object.saveCountryCapital("Japan","Tokyo");
        ...
        TreeMap<String,String> modifiedMap = object.reverseMap();
